...
$(function() {
    ...
    */
    ...
    describe('Initial Entries', function () {
        ...
        it('consists of at least 1 .entry element in .feed container when loadFeed called', function () {
    ...
    describe('New Feed Selection', function () {
        ...
        beforeEach(function (done) {
            // Run first loadfeed with callback
            loadFeed(0, function () {
                firstFeedEntries = $('.feed').find('.entry > h2').text();

                // Run second loadfeed call with a random but
                // different feed from previous cal
                let randomFeed = Math.floor(Math.random() * 3) + 1;
                loadFeed(randomFeed,function () {
                    secondFeedEntries = $('.feed').find('.entry > h2').text();
                    done();
                });
            });
        });
